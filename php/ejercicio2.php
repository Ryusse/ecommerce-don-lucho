<?php
	if (isset($_POST['register'])) {
		...
		for ($i = 1; $i <= $cantidad; $i++) {
			...
			echo "<div class='container py-2 bg-warning d-flex justify-content-left'>" . $i . "° " . $num . "
                </div>";
			...
			$descripcion = tipoNumero($num);
			
			echo "<div class='container py-2 bg-success d-flex justify-content-center'>
                        <p class='text-white m-0'>" . $num . " es un numero: " . $descripcion . "</p>
                    </div>";
